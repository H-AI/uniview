...
# Dockerfile for image built off Ubuntu 18.04 containing Python 3.8 (Python 3.6, Python 3.7) built from source
...
function download_cpython () {
    ...
    wget "https://www.python.org/ftp/python/${1}/Python-${1}.tgz" 2&> /dev/null
