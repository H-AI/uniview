...
def detections_to_csv(
    ...
    FORMAT: "oi_kaggle" (Open Images Kaggle Competition)
        ...
        Example output for two images with two detections each:
            ...
            ImageID,PredictionString
            b5d912e06f74e948,/m/05s2s 0.9 0.46 0.08 0.93 0.5 /m/0c9ph5 0.5 0.25 0.6 0.6 0.9  # noqa: E501, B950
            be137cf6bb0b62d5,/m/05s2s 0.9 0.46 0.08 0.93 0.5 /m/0c9ph5 0.5 0.25 0.6 0.6 0.9  # noqa: E501, B950
